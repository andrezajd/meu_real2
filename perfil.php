...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="brand">
            <i class="fas fa-wallet"></i> Meu Real
        </div>
        ...
        <div class="panel">
            ...
            <form action="atualizar_perfil.php" method="POST">
                ...
                <input
                    ...
                    min="1"
                    max="31"
                    value="<?php echo $dados['vencimento_cartao']; ?>">

                <label>Fechamento da fatura</label>

                <input
                    type="number"
                    name="fechamento_cartao"
                    min="1"
                    max="31"
                    value="<?php echo $dados['fechamento_cartao']; ?>">
                ...
                <input
                    ...
                    step="0.01"
                    name="limite_cartao"
                    value="<?php echo $dados['limite_cartao']; ?>">
            ...
            <div class="danger-zone">
                ...
                <p>
                    Ao desativar sua conta, seus dados serão arquivados e você será deslogado.
                </p>

                <a
                    href="acoes/arquivar_conta.php?id=<?php echo $id_usuario; ?>"
                    class="btn-delete"
