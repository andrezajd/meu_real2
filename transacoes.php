...
$disponivelLivre = max(0, $saldoBruto - $totalMeta);
...
<script>
    function filtrarTabela() {
        ...
        linhas.forEach(linha => {
            ...
            if (categoria !== 'todas' && categoriaLinha !== categoria) mostrar = false;
            if (busca && !descricaoLinha.includes(busca)) mostrar = false;
